...
if __name__ == '__main__':
    ...
    parser.add_argument('--s_arch', metavar='ARCH', default='resnet18',
                        help='backbone architecture: ' +
                             ' | '.join(architecture_names) +
                             ' (default: resnet18)')
    parser.add_argument('--t-model_param', default=None, type=str, help='path name of teacher model')
    parser.add_argument('--s-model_param', default=None, type=str, help='path name of student model')
