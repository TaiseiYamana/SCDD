...
class Office31(ImageList):
    ...
    def __init__(self, root: str, task: str, indexs = None,  download: Optional[bool] = True, **kwargs):
        ...
        super(Office31, self).__init__(root, Office31.CLASSES, data_list_file=data_list_file, indexs = indexs, **kwargs)
